const String tWelcomeTitle = "Read books";
...
// -- Splash Screen Text
const String tAppName = "Arodion";
const String tAppTagLine = "Learn To Code.Free For Everyone";
...
// -- Login Screen Text
const String tLoginTitle = "Hello!";
const String tLoginSubTitle = "Welcome back";
const String tRememberMe = "Remember Me?";
const String tDontHaveAnAccount = "Don't have an Account? ";

// -- Sign Up Screen Text
const String tSignUpTitle = "Get On Board!";
const String tSignUpSubTitle = "Let's get you started";
...
const String tOtpMessage = "Enter the verficication code sent at ";

//dashboard

const String tDashboardritle = "Hey, Coding with T";
const String tDashboardHeading = "Explore Courses";
const String tDashboardSearch = "Search...";
const String tDashboardBannerTitlel = "Android for Beginners";
...
const String tProfileHeading = "Code";
const String tProfileSubHeading = "superAdmin@gmail.com";
